...
SELECT 
    ...
    COALESCE(c.temporadas, c.duracion) AS 'Temporadas/Duración', -- Se utiliza para devolver el primer valor no nulo en una lista de expresiones. Primero evalua si c.temporadas es nulo, entonces devuelve el valor de c.duracion; si no lo es entonces devuelve el valor de c.temporadas.
